...
# start SELFPATCH
class CallingConvKind(BaseEnumeration):
    """Describes function calling convention of a type"""
    ...
    def __repr__(self):
        return 'CallingConvKind.%s' % (self.name,)

# ref: https://clang.llvm.org/doxygen/group__CINDEX__TYPES.html#ga4a0e941ec7b4b64bf9eb3d0ed49d55ae
CallingConvKind.DEFAULT = CallingConvKind(0)
CallingConvKind.C = CallingConvKind(1)
CallingConvKind.X86STDCALL = CallingConvKind(2)
CallingConvKind.X86FASTCALL = CallingConvKind(3)
CallingConvKind.X86THISCALL = CallingConvKind(4)
CallingConvKind.X86PASCAL = CallingConvKind(5)
CallingConvKind.AAPCS = CallingConvKind(6)
CallingConvKind.AAPCS_VFP = CallingConvKind(7)
CallingConvKind.X86REGCALL = CallingConvKind(8)
CallingConvKind.INTELOCLBICC = CallingConvKind(9)
CallingConvKind.WIN64 = CallingConvKind(10)
#/* Alias for compatibility with older versions of API. */
CallingConvKind.X86_64WIN64 = CallingConvKind.WIN64
CallingConvKind.X86_64SYSV = CallingConvKind(11)
CallingConvKind.X86VECTORCALL = CallingConvKind(12)
CallingConvKind.SWIFT = CallingConvKind(13)
CallingConvKind.PRESERVEMOST = CallingConvKind(14)
CallingConvKind.PRESERVEALL = CallingConvKind(15)
CallingConvKind.AARCH64VECTORCALL = CallingConvKind(16)

CallingConvKind.INVALID = CallingConvKind(100)
CallingConvKind.UNEXPOSED = CallingConvKind(200)

CallingConvKind._name_map = { CallingConvKind.C: "__cdecl", CallingConvKind.X86STDCALL: "__stdcall" }
# end SELFPATCH
...
# start SELFPATCH
    def get_func_calling_conv(self):
        """
        Retrieve the calling convention of the function type.
        """
        assert ( (self.kind == TypeKind.FUNCTIONNOPROTO) or (self.kind == TypeKind.FUNCTIONPROTO) )
        return CallingConvKind.from_id(
                conf.lib.clang_getFunctionTypeCallingConv(self))
# end SELFPATCH
