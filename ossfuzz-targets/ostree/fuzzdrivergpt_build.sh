...
cd /src/ostree
./configure --enable-static --without-selinux --prefix=/src/ostree/fuzzdrivergpt-install
...
cp -r /src/ostree/fuzzdrivergpt-install/include ${INSTALL}/include

# copy the libs to /root/workspace/fuzzdrivergpt/install/lib
cp -r /src/ostree/fuzzdrivergpt-install/lib ${INSTALL}/lib
