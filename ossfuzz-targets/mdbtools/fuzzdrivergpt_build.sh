...
cd /src/mdbtools
./configure --enable-static --disable-man --disable-glib --disable-silent-rules --prefix=/src/mdbtools/fuzzdrivergpt-install
make clean
...
cp -r /src/mdbtools/fuzzdrivergpt-install/include ${INSTALL}/include

# copy the libs to /root/workspace/fuzzdrivergpt/install/lib
cp -r /src/mdbtools/fuzzdrivergpt-install/lib ${INSTALL}/lib
