...
cd /src/librdkafka
make clean
./configure --prefix=/src/librdkafka/fuzzdrivergpt-install
...
cp -r /src/librdkafka/fuzzdrivergpt-install/include ${INSTALL}/include

# copy the libs to /root/workspace/fuzzdrivergpt/install/lib
cp -r /src/librdkafka/fuzzdrivergpt-install/lib ${INSTALL}/lib
