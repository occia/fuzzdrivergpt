...
cd /src/libmodbus
make clean
./configure --prefix=/src/libmodbus/install --disable-shared
make install
EOF
set +eux
...
cp -r /src/libmodbus/install/include /root/workspace/fuzzdrivergpt/install/include

# copy the libs to /root/workspace/fuzzdrivergpt/install/lib
cp -r /src/libmodbus/install/lib /root/workspace/fuzzdrivergpt/install/lib
