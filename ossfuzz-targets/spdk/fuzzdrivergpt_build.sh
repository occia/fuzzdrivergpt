...
cd /src/spdk
./configure --without-shared --prefix=/src/spdk/fuzzdrivergpt-install
...
cp -r /src/spdk/fuzzdrivergpt-install/include ${INSTALL}/include

# copy the libs to /root/workspace/fuzzdrivergpt/install/lib
cp -r /src/spdk/fuzzdrivergpt-install/lib ${INSTALL}/lib
