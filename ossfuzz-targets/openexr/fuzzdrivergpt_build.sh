...
mkdir build
cd build
cmake ${CMAKE_SETTINGS[@]} --install-prefix=/src/openexr/fuzzdrivergpt-install ..
...
cp -r /src/openexr/fuzzdrivergpt-install/include ${INSTALL}/include

# copy the libs to /root/workspace/fuzzdrivergpt/install/lib
cp -r /src/openexr/fuzzdrivergpt-install/lib ${INSTALL}/lib
