...
make clean
cmake . -DSTATIC_ONLY=ON -DICAL_GLIB=False --install-prefix=/src/libical/fuzzdrivergpt-install
...
cp -r /src/libical/fuzzdrivergpt-install/include ${INSTALL}/include

# copy the libs to /root/workspace/fuzzdrivergpt/install/lib
cp -r /src/libical/fuzzdrivergpt-install/lib ${INSTALL}/lib
