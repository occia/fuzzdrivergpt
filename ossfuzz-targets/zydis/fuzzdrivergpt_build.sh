...
cmake                                       \
    ...
    --install-prefix=/src/zydis/fuzzdrivergpt-install  ..
...
cp -r /src/zydis/fuzzdrivergpt-install/include ${INSTALL}/include

# copy the libs to /root/workspace/fuzzdrivergpt/install/lib
cp -r /src/zydis/fuzzdrivergpt-install/lib ${INSTALL}/lib
