...
cmake --install-prefix=/src/libdwarf/build/install ..
make install
EOF
set +eux
...
cp -r /src/libdwarf/build/install/include ${INSTALL}/include

# copy the libs to /root/workspace/fuzzdrivergpt/install/lib
cp -r /src/libdwarf/build/install/lib64 ${INSTALL}/lib64
