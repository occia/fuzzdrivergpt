...
./autogen.sh
./configure --prefix=/src/fribidi/fuzzdrivergpt-install --enable-static
...
cp -r /src/fribidi/fuzzdrivergpt-install/include ${INSTALL}/include

# copy the libs to /root/workspace/fuzzdrivergpt/install/lib
cp -r /src/fribidi/fuzzdrivergpt-install/lib ${INSTALL}/lib
