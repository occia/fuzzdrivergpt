...
export DESTDIR="/src/selinux/fuzzdrivergpt-install"
set -eux
# FILL HERE
cat >> /src/selinux/scripts/oss-fuzz.sh << 'EOF'
...
#cp -r /src/selinux/fuzzdrivergpt-install/include ${INSTALL}/include
#
## copy the libs to /root/workspace/fuzzdrivergpt/install/lib
#cp -r /src/selinux/fuzzdrivergpt-install/lib ${INSTALL}/lib
