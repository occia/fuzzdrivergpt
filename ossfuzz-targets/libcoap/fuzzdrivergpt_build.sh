...
cd /src/libcoap
./configure --disable-doxygen --disable-manpages  --disable-dtls  --prefix=/src/libcoap/fuzzdrivergpt-install
...
cp -r /src/libcoap/fuzzdrivergpt-install/include ${INSTALL}/include

# copy the libs to /root/workspace/fuzzdrivergpt/install/lib
cp -r /src/libcoap/fuzzdrivergpt-install/lib ${INSTALL}/lib
