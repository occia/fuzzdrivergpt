...
cd /src/libplist
make clean
./configure --prefix=/src/libplist/fuzzdrivergpt-install
...
cp -r /src/libplist/fuzzdrivergpt-install/include ${INSTALL}/include

# copy the libs to /root/workspace/fuzzdrivergpt/install/lib
cp -r /src/libplist/fuzzdrivergpt-install/lib ${INSTALL}/lib
