...
cd /src/miniz/build
make clean
cmake .. -DAMALGAMATE_SOURCES=ON -DBUILD_SHARED_LIBS=OFF --install-prefix=/src/miniz/fuzzdrivergpt-install
...
cp -r /src/miniz/fuzzdrivergpt-install/include ${INSTALL}/include

# copy the libs to /root/workspace/fuzzdrivergpt/install/lib
cp -r /src/miniz/fuzzdrivergpt-install/lib ${INSTALL}/lib
