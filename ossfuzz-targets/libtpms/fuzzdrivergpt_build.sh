...
cd /src/libtpms
./configure --disable-shared --enable-static --with-openssl --with-tpm2 --prefix=/src/libtpms/fuzzdrivergpt-install
...
cp -r /src/libtpms/fuzzdrivergpt-install/include ${INSTALL}/include

# copy the libs to /root/workspace/fuzzdrivergpt/install/lib
cp -r /src/libtpms/fuzzdrivergpt-install/lib ${INSTALL}/lib
