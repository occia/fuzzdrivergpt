...
cmake --install-prefix /src/croaring/fuzzdrivergpt-install ..
make install
EOF
set +eux
...
cp -r /src/croaring/fuzzdrivergpt-install/include ${INSTALL}/include

# copy the libs to /root/workspace/fuzzdrivergpt/install/lib
cp -r /src/croaring/fuzzdrivergpt-install/lib ${INSTALL}/lib
