...
cd /src/zlib
./configure --prefix=/src/zlib/fuzzdrivergpt-install
...
cp -r /src/zlib/fuzzdrivergpt-install/include ${INSTALL}/include

# copy the libs to /root/workspace/fuzzdrivergpt/install/lib
cp -r /src/zlib/fuzzdrivergpt-install/lib ${INSTALL}/lib
