...
./configure --disable-ogg --disable-oggspots --disable-libxml2 --disable-lua \
            ...
            --disable-xcb \
            --disable-alsa \
            --with-libfuzzer --prefix=/src/vlc/fuzzdrivergpt-install
...
cp -r /src/vlc/fuzzdrivergpt-install/include ${INSTALL}/include

# copy the libs to /root/workspace/fuzzdrivergpt/install/lib
cp -r /src/vlc/fuzzdrivergpt-install/lib ${INSTALL}/lib
