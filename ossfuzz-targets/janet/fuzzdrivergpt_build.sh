...
cd /src/janet
make install PREFIX=/src/janet/fuzzdrivergpt-install
...
cp -r /src/janet/fuzzdrivergpt-install/include ${INSTALL}/include

# copy the libs to /root/workspace/fuzzdrivergpt/install/lib
cp -r /src/janet/fuzzdrivergpt-install/lib ${INSTALL}/lib
