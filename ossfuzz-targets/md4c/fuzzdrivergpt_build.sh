...
cd /src/md4c/build
make clean
cmake ../ -DBUILD_SHARED_LIBS=OFF --install-prefix=/src/md4c/fuzzdrivergpt-install
...
cp -r /src/md4c/fuzzdrivergpt-install/include ${INSTALL}/include

# copy the libs to /root/workspace/fuzzdrivergpt/install/lib
cp -r /src/md4c/fuzzdrivergpt-install/lib ${INSTALL}/lib
