...
cd /src/libsrtp
./configure --prefix=/src/libsrtp/fuzzdrivergpt-install
...
cp -r /src/libsrtp/fuzzdrivergpt-install/include ${INSTALL}/include

# copy the libs to /root/workspace/fuzzdrivergpt/install/lib
cp -r /src/libsrtp/fuzzdrivergpt-install/lib ${INSTALL}/lib
