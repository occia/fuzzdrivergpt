...
./configure --disable-shared --disable-shared-libutil --enable-static-sudoers \
    ...
    --enable-warnings --enable-werror --prefix=/src/sudo/fuzzdrivergpt-install
...
#cp -r /src/sudoers/fuzzdrivergpt-install/include ${INSTALL}/include
#
## copy the libs to /root/workspace/fuzzdrivergpt/install/lib
#cp -r /src/sudoers/fuzzdrivergpt-install/lib ${INSTALL}/lib
