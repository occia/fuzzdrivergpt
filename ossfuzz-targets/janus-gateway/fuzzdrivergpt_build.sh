...
./configure --prefix=/src/janus-gateway/fuzzdrivergpt-install --enable-static
...
cp -r /src/janus-gateway/fuzzdrivergpt-install/include ${INSTALL}/include

# copy the libs to /root/workspace/fuzzdrivergpt/install/lib
cp -r /src/janus-gateway/fuzzdrivergpt-install/lib ${INSTALL}/lib
