...
mkdir build1
cd build1
cmake -DCMAKE_BUILD_TYPE=Release -DCMAKE_VERBOSE_MAKEFILE=ON --install-prefix=/src/openjpeg/fuzzdrivergpt-install ..
...
cp -r /src/openjpeg/fuzzdrivergpt-install/include ${INSTALL}/include

# copy the libs to /root/workspace/fuzzdrivergpt/install/lib
cp -r /src/openjpeg/fuzzdrivergpt-install/lib ${INSTALL}/lib
