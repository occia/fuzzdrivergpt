...
cd /src/brotli
cmake . -DBUILD_TESTING=OFF -DBUILD_SHARED_LIBS=OFF --install-prefix=/src/brotli/fuzzdrivergpt-install
make clean
...
cp -r /src/brotli/fuzzdrivergpt-install/include ${INSTALL}/include

# copy the libs to /root/workspace/fuzzdrivergpt/install/lib
cp -r /src/brotli/fuzzdrivergpt-install/lib ${INSTALL}/lib
