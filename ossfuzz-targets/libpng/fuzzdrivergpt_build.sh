...
cd /src/libpng
./configure --with-libpng-prefix=OSS_FUZZ_ --prefix=/src/libpng/fuzzdrivergpt-install
...
cp -r /src/libpng/fuzzdrivergpt-install/include ${INSTALL}/include

# copy the libs to /root/workspace/fuzzdrivergpt/install/lib
cp -r /src/libpng/fuzzdrivergpt-install/lib ${INSTALL}/lib
