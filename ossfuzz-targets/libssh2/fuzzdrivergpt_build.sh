...
./configure --disable-shared \
            ...
            --enable-debug --prefix=/src/libssh2/fuzzdrivergpt-install
...
cp -r /src/libssh2/fuzzdrivergpt-install/include ${INSTALL}/include

# copy the libs to /root/workspace/fuzzdrivergpt/install/lib
cp -r /src/libssh2/fuzzdrivergpt-install/lib ${INSTALL}/lib
