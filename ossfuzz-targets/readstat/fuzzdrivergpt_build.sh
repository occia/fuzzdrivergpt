...
cd /src/readstat
./configure --enable-static --prefix=/src/readstat/fuzzdrivergpt-install
...
cp -r /src/readstat/fuzzdrivergpt-install/include ${INSTALL}/include

# copy the libs to /root/workspace/fuzzdrivergpt/install/lib
cp -r /src/readstat/fuzzdrivergpt-install/lib ${INSTALL}/lib
