...
./configure --enable-oss-fuzz PCRE2_LIBS=-l:libpcre2-8.a --prefix=/src/varnish-cache/fuzzdrivergpt-install
...
cp -r /src/varnish-cache/fuzzdrivergpt-install/include ${INSTALL}/include

# copy the libs to /root/workspace/fuzzdrivergpt/install/lib
cp -r /src/varnish-cache/fuzzdrivergpt-install/lib ${INSTALL}/lib
