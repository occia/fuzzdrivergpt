...
cd /src/oniguruma
make clean
./configure --prefix=/src/oniguruma/fuzzdrivergpt-install
...
cp -r /src/oniguruma/fuzzdrivergpt-install/include ${INSTALL}/include

# copy the libs to /root/workspace/fuzzdrivergpt/install/lib
cp -r /src/oniguruma/fuzzdrivergpt-install/lib ${INSTALL}/lib
