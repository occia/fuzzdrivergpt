...
cd /src/lz4/lib
make install -j$(nproc) PREFIX=/src/lz4/fuzzdrivergpt-install
...
cp -r /src/lz4/fuzzdrivergpt-install/include ${INSTALL}/include

# copy the libs to /root/workspace/fuzzdrivergpt/install/lib
cp -r /src/lz4/fuzzdrivergpt-install/lib ${INSTALL}/lib
