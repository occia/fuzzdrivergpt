...
cmake -DCMAKE_BUILD_TYPE=Release -DURIPARSER_BUILD_DOCS:BOOL=OFF -DBUILD_SHARED_LIBS:BOOL=OFF -DURIPARSER_BUILD_TESTS:BOOL=OFF --install-prefix=/src/uriparser/fuzzdrivergpt-install  ..
...
cp -r /src/uriparser/fuzzdrivergpt-install/include ${INSTALL}/include

# copy the libs to /root/workspace/fuzzdrivergpt/install/lib
cp -r /src/uriparser/fuzzdrivergpt-install/lib ${INSTALL}/lib
