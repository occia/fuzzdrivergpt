...
cd /src/wolfmqtt
make clean
./configure --enable-static --disable-examples --enable-mqtt5 --prefix=/src/wolfmqtt/fuzzdrivergpt-install
...
cp -r /src/wolfmqtt/fuzzdrivergpt-install/include ${INSTALL}/include

# copy the libs to /root/workspace/fuzzdrivergpt/install/lib
cp -r /src/wolfmqtt/fuzzdrivergpt-install/lib ${INSTALL}/lib
